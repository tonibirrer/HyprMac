...
final class TilingEngineMembershipTransactionTests: XCTestCase {
    ...
    func testSameHomeDisplayChangeSupersedesAnActiveCandidate() throws {
        ...
        f.trace.onWrite = {
            ...
            changed = true
            f.engine.handleDisplayChange(currentScreens: [f.screen], homeScreensForWorkspace: { _ in [f.screen] })
        }
...
private final class MembershipTestScreen: NSScreen {
    ...
    override var localizedName: String { "MembershipTestScreen" }
...
private final class PortraitMembershipTestScreen: NSScreen {
    // detached test screen: AppKit traps naming it on macOS 26
    override var localizedName: String { "PortraitMembershipTestScreen" }
...
private final class MembershipHomeScreen: NSScreen {
    // detached test screen: AppKit traps naming it on macOS 26
    override var localizedName: String { "MembershipHomeScreen" }
